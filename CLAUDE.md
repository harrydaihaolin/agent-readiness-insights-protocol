# CLAUDE.md — agent-readiness-insights-protocol
...
2. Run `make lint && make test` before opening a PR.
...
`make lint && make test` is non-interactive. No prompts, no human input. If you add
